...
// Load classes
spl_autoload_register('tigerduck42\mmFramework\customAutoLoader');

// Error handler
set_error_handler("tigerduck42\mmFramework\customError");

// Exception handler
set_exception_handler("tigerduck42\mmFramework\customException");
