...
class SimpleCaptcha
{
  ...
  {
    $this->resourcesPath = DIR_FRAMEWORK . '/thirdParty/cool-php-captcha-0.3.1/resources';
  }
  ...
  public function createImage()
  {
    ...
    /** Text insertion */
    $text = $this->_getCaptchaText();
    $fontcfg  = $this->fonts[array_rand($this->fonts)];
    $this->_writeText($text, $fontcfg);
   ...
   * @return string Text
   */
  protected function _getCaptchaText()
  {
    $text = $this->_getDictionaryCaptchaText();
    if (!$text) {
        $text = $this->_getRandomCaptchaText();
    }
    return $text;
  }
   ...
   * @return string Word
   */
  protected function _getDictionaryCaptchaText($extended = FALSE)
  {
